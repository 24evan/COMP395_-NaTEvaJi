...
public class Service : MonoBehaviour
{
    ...
    private float currentServiceTime =0f;
            ...
            if (currentCustomer.transform.position == ATM.transform.position)
            {
                ...
                if (isInService)
                {
                    if (currentServiceTime > 0)
                    {
                        ...
                        serviceTxt.text = currentServiceTime.ToString("0.0");
                    }
                    else   //when service time is run out current customer becomes exiting customer
                    {
                        ...
                        currentServiceTime = GenerateServiceTimes();
                    }
                }
            }
        }
    ...
    private float GenerateServiceTimes()
    { 
